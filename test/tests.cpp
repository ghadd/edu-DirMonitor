...
CxxTest::StaticSuiteDescription
    suiteDescription_DirMonitorTest("test/dirmonitor_test.h", 11,
                                    "DirMonitorTest", suite_DirMonitorTest,
                                    Tests_DirMonitorTest);

static class TestDescription_suite_DirMonitorTest_testApplyMonitor
    : public CxxTest::RealTestDescription {
public:
  TestDescription_suite_DirMonitorTest_testApplyMonitor()
      : CxxTest::RealTestDescription(Tests_DirMonitorTest,
                                     suiteDescription_DirMonitorTest, 13,
                                     "testApplyMonitor") {}
  void runTest() { suite_DirMonitorTest.testApplyMonitor(); }
} testDescription_suite_DirMonitorTest_testApplyMonitor;

static class TestDescription_suite_DirMonitorTest_testApplyMonitorInvalidPath
    : public CxxTest::RealTestDescription {
public:
  TestDescription_suite_DirMonitorTest_testApplyMonitorInvalidPath()
      : CxxTest::RealTestDescription(Tests_DirMonitorTest,
                                     suiteDescription_DirMonitorTest, 42,
                                     "testApplyMonitorInvalidPath") {}
