...
QPair<QVector<FileInfo>, quint64> DirMonitor::applyMonitor() {
    ...
    QDirIterator it(monitoringDir_.path(), QDir::Files, QDirIterator::Subdirectories);
    ...
    quint64 totalFilesSize = std::accumulate(infos.begin(), infos.end(), 0LL, [](quint64 init, const FileInfo &finfo) {
